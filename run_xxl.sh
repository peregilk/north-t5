T5X_CHECKPOINT_PATH="gs://north-t5x/pretrained_models/xxl/norwegian_NCC_plus_English_t5x_xxl/checkpoint_1500000"
FLAX_DUMP_FOLDER_PATH="/home/perk/models/north-t5-xxl/"
CONFIG_NAME="xxl.json"
